    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="artistas/artistas.views.php" target="base" class="menu-link">
                        <?php $_SESSION['rutas'] = 'Artistas'; ?>
                        <div data-i18n="Without navbar">Artistas</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="albunes/albunes.views.php" target="base" class="menu-link">
                        <?php $_SESSION['rutas'] = 'Tareas'; ?>
                        <div data-i18n="Without navbar">Albunes</div>
                    </a>
                </li>
                <li class="menu-item">
